...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            'databases' => [
                env('DB_CONNECTION', 'pgsql'), // PostgreSQL sesuai PRD Tech Stack
            ],
        ],
         ...
         */
        // Gzip compressor dinonaktifkan untuk kompatibilitas Windows (dev lokal)
        // Di server Linux production, bisa diaktifkan kembali dengan:
        // Spatie\DbDumper\Compressors\GzipCompressor::class
         ...
         */
        // Format timestamp pada nama file dump — contoh: db-2026-08-04-01-00-00.sql
