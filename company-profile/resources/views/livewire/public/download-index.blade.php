<div>
    <div style="background: #e2e8f0; padding: 40px; text-align: center; margin-bottom: 30px;">
        <h1>Catalogs & Downloads</h1>
        <p>Download our latest company profiles and product catalogs.</p>
        ...
        @forelse($downloads as $download)
            <div style="display: flex; justify-content: space-between; align-items: center; background: white; padding: 20px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 8px;">
                <div>
                    ...
                    <p style="margin: 0; font-size: 12px; color: #666;">Downloaded {{ $download->download_count }} times</p>
                </div>
                
                <div>
                    @if($download->require_email)
                        <div style="display: flex; gap: 10px; align-items: center;">
                            <input type="email" wire:model="email" placeholder="Enter your email" style="padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
