<div>
    ...
    <div style="max-width: 1000px; margin: 0 auto; padding: 20px;">
        ...
        <a href="{{ route('products.index') }}" style="color: #2563eb; text-decoration: none;">&larr; Back to Products</a>
        ...
        <div style="display: flex; gap: 40px; margin-top: 20px;">
            ...
            <div style="flex: 1;">
                ...
                @else
                    <div style="width: 100%; height: 400px; background: #eee; display: flex; align-items: center; justify-content: center; border-radius: 8px;">No Image Available</div>
                @endif
            </div>
            ...
            <div style="flex: 1;">
                ...
                <p style="font-size: 14px; color: #666; margin-bottom: 20px;">HS Code: {{ $product->hs_code ?? '-' }} | Origin: {{ $product->origin ?? '-' }}</p>
